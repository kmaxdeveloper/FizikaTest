    ...
    override fun doWork(): Result {
        ...
        if (hour in 10..21) {
            ...
            val titles = arrayOf(
                ...
                "Fizika bo'yicha chempionmisiz? 🏆",
                "Atigi 2 daqiqa vaqt ajrating ⏱️",
                "Yangi qiziqarli testlar tayyor! 🔬",
                "Miyangizni mashq qildiring 🧠",
                "Fizika qonunlarini sinab ko'ramizmi? ⚡",
                "Sizni kutmoqdamiz! 🚀",
                "Bilimingizni sinash vaqti keldi 📚",
                "Bugungi natijangiz qanday bo'ladi? 🎯",
                "Fizikani biz bilan oson o'rganing 🪐"
            )
            val messages = arrayOf(
                "Kunlik fizika testini yechib, o'z bilimingizni yangilab oling.",
                "Siz uchun maxsus saralangan test savollarimiz bor. Qani boshladik!",
                "Bilimingiz zanglab qolmasin. Bugun 5 ta savolga javob bering.",
                "Fizika qiyin emas, asosiysi muntazamlik. Birga davom etamiz!",
                "O'z darajangizni oshirish uchun ideal vaqt. Ilovaga kiring.",
                "Bugun qaysi yangi formula yoki qonunni o'rganasiz? Tekshirib ko'ring.",
                "Sizning natijangiz boshqalardan yuqori bo'lishi mumkin!",
                "Fizika sirlarini ochishda davom eting. Yangi testlar yuklandi.",
