...
import uz.kmax.fizikatest.databinding.ItemNativeAdBinding
...
class AdsManager @Inject constructor(
    ...
    private val MIN_INTERVAL_AFTER_APP_OPEN = 60000L // 60 sekund
    ...
    fun showAds(activity: Activity, isBackPress: Boolean = false, onResultShowAds: ((Boolean) -> Unit)? = null) {
        ...
        val timeSinceAppOpen = currentTime - lastAppOpenAdTime

        // 45 sekundlik interval yoki App Open dan keyingi 60 sekundlik cheklovni tekshirish
        if (timeSinceLastAd < MIN_AD_INTERVAL || timeSinceAppOpen < MIN_INTERVAL_AFTER_APP_OPEN) {
