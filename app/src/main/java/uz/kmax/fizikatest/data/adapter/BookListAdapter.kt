...
import uz.kmax.fizikatest.databinding.ItemBookBinding
...
class BookListAdapter :
    ...
    private fun setDataToView(binding: ItemBookBinding, path: String) {
        val storage = Firebase.storage.getReference("FizikaTest/Content/SchoolBooks/BookCover/")
        val imageRef: StorageReference = storage.child("$path.png")
