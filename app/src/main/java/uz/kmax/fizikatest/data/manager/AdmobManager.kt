...
class AdmobManager(private var context: Context) {
    ...
    private val AD_UNIT_ID = "ca-app-pub-4664801446868642/3106782784"
    private val AD_UNIT_ID_REWARDED = "ca-app-pub-4664801446868642/8644151005"
    private val AD_UNIT_ID_NATIVE = "ca-app-pub-4664801446868642/4210081977"
    ...
    fun loadNativeAd(onLoaded: (NativeAd?) -> Unit) {
        val adLoader = AdLoader.Builder(context, AD_UNIT_ID_NATIVE)
