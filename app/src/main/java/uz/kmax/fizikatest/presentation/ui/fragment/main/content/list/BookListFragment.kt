package uz.kmax.fizikatest.presentation.ui.fragment.main.content.list
...
import uz.kmax.fizikatest.databinding.FragmentBookListBinding
import uz.kmax.fizikatest.domain.models.BaseBookData
import uz.kmax.fizikatest.presentation.ui.dialog.DialogBookNotExist
import uz.kmax.fizikatest.presentation.ui.fragment.main.MenuFragment
import uz.kmax.fizikatest.presentation.ui.fragment.main.content.BookFragment
import java.io.File
        ...
        adapter.setOnItemSendListener {
            ...
            if (internalFile.exists()) {
                ...
                dialog.setOnDownloadNowListener { type ->
                    when (type) {
                        1 -> {
                            downloadAndSavePDF(requireContext(), fileName, "FizikaTest/Content/SchoolBooks/Book/$fileName") { fileUri ->
